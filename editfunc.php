...
if ($originalUsernameResult && mysqli_num_rows($originalUsernameResult) > 0) {
    ...
    $updateQuery = "UPDATE users SET username='$username', password='$ramz_pas', tel='$tel', first_name='$fname', last_name='$lname', codemeli='$codemeli', nickname='$nick_name', address='$Addres', date_of_birth='$date_of_birth' WHERE user_id='$nUid'";
